...
class ConnectionPolicy
{
    ...
    {
        return $user->can('delete_connection');
    }
    ...
    {
        return $user->can('force_delete_connection');
    }
    ...
    {
        return $user->can('force_delete_any_connection');
    }
    ...
    {
        return $user->can('restore_connection');
    }
    ...
    {
        return $user->can('restore_any_connection');
    }

    /**
     * Determine whether the user can replicate.
     */
    public function replicate(User $user, Connection $connection): bool
    {
        return $user->can('replicate_connection');
    }
    ...
    {
        return $user->can('reorder_connection');
    }
}
